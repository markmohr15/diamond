...
BallInPlay ballInPlayFromJson(String str) =>
    BallInPlay.fromJson(json.decode(str));

String ballInPlayToJson(BallInPlay data) => json.encode(data.toJson());

CountCorrection countCorrectionFromJson(String str) =>
    CountCorrection.fromJson(json.decode(str));

String countCorrectionToJson(CountCorrection data) =>
    json.encode(data.toJson());

FielderTouch fielderTouchFromJson(String str) =>
    FielderTouch.fromJson(json.decode(str));

String fielderTouchToJson(FielderTouch data) => json.encode(data.toJson());

InningHalfEnd inningHalfEndFromJson(String str) =>
    InningHalfEnd.fromJson(json.decode(str));

String inningHalfEndToJson(InningHalfEnd data) => json.encode(data.toJson());

InningHalfStart inningHalfStartFromJson(String str) =>
    InningHalfStart.fromJson(json.decode(str));

String inningHalfStartToJson(InningHalfStart data) =>
    json.encode(data.toJson());
...
PitchThrown pitchThrownFromJson(String str) =>
    PitchThrown.fromJson(json.decode(str));
...
RunnerAdvance runnerAdvanceFromJson(String str) =>
    RunnerAdvance.fromJson(json.decode(str));
...
class BallInPlay {
  ...
  factory BallInPlay.fromJson(Map<String, dynamic> json) => BallInPlay(
    ...
    endedAt: json["endedAt"] == null
        ? null
        : FieldCoord.fromJson(json["endedAt"]),
    fair: json["fair"],
...
enum ContactQuality { AVERAGE, HARD, WEAK }
...
class FieldCoord {
  ...
  FieldCoord({required this.x, required this.y});

  factory FieldCoord.fromJson(Map<String, dynamic> json) =>
      FieldCoord(x: json["x"]?.toDouble(), y: json["y"]?.toDouble());

  Map<String, dynamic> toJson() => {"x": x, "y": y};
}

enum Trajectory { BUNT, FLY, GROUND, LINE, POPUP }
...
class CountCorrection {
  ...
  CountCorrection({required this.balls, required this.strikes});

  factory CountCorrection.fromJson(Map<String, dynamic> json) =>
      CountCorrection(balls: json["balls"], strikes: json["strikes"]);
...
class FielderTouch {
  ...
  factory FielderTouch.fromJson(Map<String, dynamic> json) => FielderTouch(
    ...
    location: json["location"] == null
        ? null
        : FieldCoord.fromJson(json["location"]),
...
///how a received_throw arrived (§13, §22.1). Default clean; purely developmental, never
///affects official scoring.
enum ReceivedQuality { CLEAN, HIGH, SHORT_HOP, WIDE }
...
class InningHalfEnd {
  ...
  InningHalfEnd({required this.reason});

  factory InningHalfEnd.fromJson(Map<String, dynamic> json) =>
      InningHalfEnd(reason: inningHalfEndReasonValues.map[json["reason"]]!);
...
class InningHalfStart {
  ...
  factory InningHalfStart.fromJson(Map<String, dynamic> json) =>
      InningHalfStart(
        ...
        snapshot: json["snapshot"] == null
            ? null
            : GameStateSnapshot.fromJson(json["snapshot"]),
      );
...
enum Half { BOTTOM, TOP }

final halfValues = EnumValues({"bottom": Half.BOTTOM, "top": Half.TOP});
...
class GameStateSnapshot {
  ...
  factory GameStateSnapshot.fromJson(Map<String, dynamic> json) =>
      GameStateSnapshot(
        inferredPitchEffects: Map.from(json["inferredPitchEffects"]).map(
          (k, v) => MapEntry<String, InferredPitchEffect>(
            k,
            inferredPitchEffectValues.map[v]!,
          ),
        ),
        nextBatterIndexByTeam: Map.from(
          json["nextBatterIndexByTeam"],
        ).map((k, v) => MapEntry<String, int>(k, v)),
        pitchCountByPitcher: Map.from(
          json["pitchCountByPitcher"],
        ).map((k, v) => MapEntry<String, int>(k, v)),
        runsByTeam: Map.from(
          json["runsByTeam"],
        ).map((k, v) => MapEntry<String, int>(k, v)),
  ...
  Map<String, dynamic> toJson() => {
    "inferredPitchEffects": Map.from(inferredPitchEffects).map(
      (k, v) =>
          MapEntry<String, dynamic>(k, inferredPitchEffectValues.reverse[v]),
    ),
    "nextBatterIndexByTeam": Map.from(
...
enum InferredPitchEffect { BALL, STRIKE_EFFECT }
...
class LineupSet {
  ...
  LineupSet({required this.battingOrder, required this.teamId});
...
class PitchThrown {
  ...
  factory PitchThrown.fromJson(Map<String, dynamic> json) => PitchThrown(
    actualLocation: json["actualLocation"] == null
        ? null
        : ZoneCoord.fromJson(json["actualLocation"]),
    ...
    bounceLocation: json["bounceLocation"] == null
        ? null
        : BounceCoord.fromJson(json["bounceLocation"]),
    intendedLocation: json["intendedLocation"] == null
        ? null
        : ZoneCoord.fromJson(json["intendedLocation"]),
...
class ZoneCoord {
  ...
  ZoneCoord({required this.x, required this.y});

  factory ZoneCoord.fromJson(Map<String, dynamic> json) =>
      ZoneCoord(x: json["x"]?.toDouble(), y: json["y"]?.toDouble());
...
///plus a non-bunt trajectory nearly implies it, because that only works when she makes
///contact and the deception is the whole scouting point.
enum BatterAction { BUNT, SLAP, SLASH }
...
final batterSideValues = EnumValues({"L": BatterSide.L, "R": BatterSide.R});
...
class BounceCoord {
  ...
  BounceCoord({this.depth, required this.x});

  factory BounceCoord.fromJson(Map<String, dynamic> json) =>
      BounceCoord(depth: json["depth"]?.toDouble(), x: json["x"]?.toDouble());

  Map<String, dynamic> toJson() => {"depth": depth, "x": x};
}
...
///Absent means the ball did not get away — she reached on an error (see `enabledByTouchId`)
///or simply beat the throw. Never inferred: the scorer says which, always.
enum Cause { PASSED_BALL, WILD_PITCH }
...
class VoidEvent {
  ...
  VoidEvent({required this.targetId});

  factory VoidEvent.fromJson(Map<String, dynamic> json) =>
      VoidEvent(targetId: json["targetId"]);
