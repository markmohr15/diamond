...
void main() {
  ...
  test(
    'play-2 continuation: the runner who reached on a charged error is '
  ...
  test(
    'play-4 continuation: homer after the dropped foul that should have '
  ...
  test(
    'an error-enabled advance breaks the chain: scoring from the stolen '
  ...
  test(
    'runs after the reconstructed third out are unearned, including a '
    'later clean homer',
    () {
      final b = EventBuilder();
      final rulings = reconstructEarnedRuns(
