...
void main() {
  ...
  test("Mark's counterexample: a known foul inside the span makes the "
  ...
  test('multiset-ambiguity counterexample: 0-0 -> 2-1 with three unknowns is '
  ...
  test('single unknown at 2 strikes, checkpoint unchanged: the only '
  ...
  test('a candidate that would end the AB before the span is exhausted is '
